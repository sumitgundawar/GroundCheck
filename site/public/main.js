  ...
  const RUNS = [
    {
      ...
      stages: [
        ["pass", "PII redaction", "no personal data found", 8],
        ["pass", "Scope check", "no injection patterns", 6],
        ["pass", "Rate limit", "within limit", 2],
        ["pass", "Retrieve", "top 4 passages, best score 0.71", 745],
        ["pass", "Retrieval gate", "0.71 clears the 0.30 threshold", 1],
        ["fail", "Source coverage", "“zalortin” is in no trusted source", 4],
    ...
    },
    {
      ...
      stages: [
        ...
        ["pass", "Retrieve", "top 4 passages, best score 0.72", 184],
        ["pass", "Retrieval gate", "0.72 clears the 0.30 threshold", 0],
        ["pass", "Source coverage", "every key term is in a source", 0],
        ["info", "Generate", "4 claims drafted from sources", 57],
        ["pass", "Schema validation", "4 claims match the schema", 0],
        ["pass", "Grounding check", "all 4 claims grounded", 40],
